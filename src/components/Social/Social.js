...
import { LinkedIn, GitHub, Email, Facebook } from "@material-ui/icons";
  ...
  if (mobile) {
    return (
      <div className={classes.mobileWrapper}>
        <IconBtn icon={GitHub} m={1} href="https://github.com/jarko1985" />
        <IconBtn
          icon={Facebook}
          m={1}
          href="https://www.facebook.com/hassan.jarko"
        />
        <IconBtn
          icon={LinkedIn}
          m={1}
        ...
        />
        <IconBtn icon={Email} m={1} href="mailto:hassan.jarko@yahoo.com" />
      </div>
    );
  } else {
    return (
